                    ...
                    <div class="col">
                        <div class="product-item-detail-tabs-container">
                            <ul class="product-item-detail-tabs-list">
                                ...
                                ?>
                                <li class="product-item-detail-tab active" data-entity="tab" data-value="delivery">
                                    <a href="javascript:void(0);" class="product-item-detail-tab-link">
                                        <span><?= GetMessage('CP_BCE_TPL_MESS_DELIVERY') ?></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="product-item-detail-tab-content active" data-entity="tab-container"
                            ...
                            <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    ...
                                    "ID" => "",
                                    "CODE" => "",
                                    "INPUT_NAME" => "LOCATION_HIDDEN_INPUT",
                                    "PROVIDE_LINK_BY" => "id",
                                    "JSCONTROL_GLOBAL_ID" => "",
                                    "JS_CALLBACK" => "",
                                    "FILTER_BY_SITE" => "Y",
                            ...
                            <br>
                            <div class="js-shipment-table"></div>
                        </div>
                    </div>
                </div>
            </div>
